...
void insere (universidade aluno[]){
    ...
    aluno[7].matricula = 2233; strcpy(aluno[7].nome, "Ana"); aluno[7].nota1 = 7.6; aluno[7].nota2 = 6.9; aluno[7].media = (aluno[7].nota1 + aluno[7].nota2)/2;
    aluno[8].matricula = 1097; strcpy(aluno[8].nome, "Juarez"); aluno[8].nota1 = 8.8; aluno[8].nota2 = 6.9; aluno[8].media = (aluno[8].nota1 + aluno[8].nota2)/2;
    aluno[9].matricula = 2004; strcpy(aluno[9].nome, "Jonas"); aluno[9].nota1 = 4.9; aluno[9].nota2 = 9.8; aluno[9].media = (aluno[9].nota1 + aluno[9].nota2)/2;
}
